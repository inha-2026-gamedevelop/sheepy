...
namespace Minsung.Sound
{
    ...
    public class BgmZoneExitTrigger : MonoBehaviour
    {
        [Header("대상 설정")]
        [SerializeField] private GameObject _targetObject; // <--- 인스펙터에서 감지할 오브젝트를 지정하세요.
        ...
        {
            if ((SoundManager.Instance == null) || other.gameObject != _targetObject)
            {
                return;
            }
