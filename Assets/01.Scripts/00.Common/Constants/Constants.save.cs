namespace Minsung.Common
{
    public static partial class Constants
    {
        ...
        public static class Save
        {
            ...
            public const string KEY_HUD_TUTORIAL_SEEN = "Save_HudTutorialSeen"; // PlayerHUD 최초 안내 튜토리얼 시청 여부 (0/1)
            public const string KEY_LOCAL_UPDATED_AT = "Save_LocalUpdatedAtUtcTicks"; // 로컬 진행 데이터 마지막 변경 시각(UTC ticks) - 서버 최신성 비교 기준
        }
    }
}
